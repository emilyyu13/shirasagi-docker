# This script creates a CSS folder and file that are visible in the Shirasagi backend folder view
# It ensures the CSS file appears when the "フォルダー" link is clicked

puts "Starting final CSS folder visibility fix..."
...
# Create a visible folder node at the root level
css_node = Cms::Node.new
css_node.site_id = site.id
css_node.name = "CSS"
css_node.filename = "css"
css_node.route = "cms/page" # Try a different route type
...
puts "Final CSS folder visibility fix completed successfully!"
